...
# Load globally
with open('resources/ohe_encoder.pkl', 'rb') as f:
    ohe_encoder = pickle.load(f)

with open('resources/service_encoding.pkl', 'rb') as f:
    service_encoding = pickle.load(f)

with open('resources/nadp_X_train_binary_scaler.pkl', 'rb') as f:
    nadp_X_train_binary_scaler = pickle.load(f)

with gzip.open('resources/nadp_X_train_binary_final.pkl', 'rb') as f:
    nadp_X_train_binary_final = pickle.load(f)

with open("resources/train_binary_iforest.pkl","rb") as f:
    train_binary_iforest = pickle.load(f)

with open("resources/train_binary_robust_cov.pkl","rb") as f:
    train_binary_robust_cov = pickle.load(f)

with open("resources/train_binary_one_class_svm.pkl","rb") as f:
    train_binary_one_class_svm = pickle.load(f)

with open("resources/train_binary_knn.pkl","rb") as f:
    train_binary_knn = pickle.load(f)

with open("resources/train_binary_gmm.pkl","rb") as f:
    train_binary_gmm = pickle.load(f)

with open("resources/k_means_scaler.pkl","rb") as f:
    k_means_scaler = pickle.load(f)

with open("resources/kmeans_best.pkl","rb") as f:
    kmeans_best = pickle.load(f)

with open("resources/kmeans_adv_scaler.pkl","rb") as f:
    kmeans_adv_scaler = pickle.load(f)

with open("resources/best_binary_classification_model.pkl","rb") as f:
